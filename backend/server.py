...
async def create_checkout_setup_session(user_id: str):
    ...
    try:
        host_url = os.environ.get('FRONTEND_URL', 'https://landlord-tools-5.preview.emergentagent.com')
...
async def send_builder_document(doc: DocumentBuilderSend):
    ...
    try:
        ...
        sign_link = f"https://landlord-tools-5.preview.emergentagent.com/sign-document/{doc_id}"
